...
def get_dealerships(request):
    if request.method == "GET":
        url = "https://saumyasriva2-3000.theiadocker-1-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/dealerships/get"
...
def get_dealer_details(request, dealer_id):
    if request.method == "GET":
        url = "https://saumyasriva2-5000.theiadocker-1-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/api/get_reviews"
        # Get dealers from the URL
...
def add_review(request, dealer_id):
    if request.method == 'POST':
        ...
        url = "https://saumyasriva2-5000.theiadocker-1-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/api/post_review"
